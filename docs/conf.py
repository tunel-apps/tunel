...
# -*- coding: utf-8 -*-
#
# tunel documentation build configuration file, created by
...
project = "Tunel"
copyright = "2021-2022, Vanessa Sochat"

from tunel import version
...
latex_documents = [
    ("index", "tunel.tex", "Tunel Documentation", "Vanessa Sochat", "manual"),
]
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "tunel",
        "Developer interfaces for apps and HPC via tunneling",
        "Miscellaneous",
    ),
]
